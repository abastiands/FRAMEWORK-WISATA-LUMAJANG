...
<div class="row">
	...
	<div class="col-lg-7">
		<div class="card">
			<div class="card-header">Lokasi Wisata Alam</div>
			<div class="card-body">
	...
	<div class="col-lg-5">
		<div class="card">
			<div class="card-header">Data Wisata Alam</div>
			<div class="card-body">
				<?php
...
<script>
	...
	if (curLocation[0] == 0 && curLocation[1] == 0) {
		curLocation = [-8.1303639, 113.197253];
	}

	var mymap = L.map('mapid').setView([-8.1303639, 113.197253], 11);
	L.tileLayer('https://api.mapbox.com/styles/v1/{id}/tiles/{z}/{x}/{y}?access_token=pk.eyJ1IjoiYWJhc3RpYW5kcyIsImEiOiJja3gxZnV3ODUwcTF4Mm9xbDhmZDJ5NmF3In0.pIAWWlA5eS_3FD6cGkLL0g', {
