...
<script>
	navigator.geolocation.getCurrentPosition(function(location) {
		...
		var peta1 = L.tileLayer('https://api.mapbox.com/styles/v1/{id}/tiles/{z}/{x}/{y}?access_token=pk.eyJ1IjoiYWJhc3RpYW5kcyIsImEiOiJja3gxZnV3ODUwcTF4Mm9xbDhmZDJ5NmF3In0.pIAWWlA5eS_3FD6cGkLL0g', {
		...
		var peta2 = L.tileLayer('https://api.mapbox.com/styles/v1/{id}/tiles/{z}/{x}/{y}?access_token=pk.eyJ1IjoiYWJhc3RpYW5kcyIsImEiOiJja3gxZnV3ODUwcTF4Mm9xbDhmZDJ5NmF3In0.pIAWWlA5eS_3FD6cGkLL0g', {
			attribution: 'Map data &copy; <a href="https://www.openstreetmap.org/">OpenStreetMap</a> contributors, ' +
				'<a href="https://creativecommons.org/licenses/by-sa/2.0/">CC-BY-SA</a>, ' +
				'Imagery © <a href="https://www.mapbox.com/">Mapbox</a>',
